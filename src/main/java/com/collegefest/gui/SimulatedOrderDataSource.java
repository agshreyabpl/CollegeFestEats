 ...
 *
 * Singleton — same pattern as the project's Database class — so both
 * StudentDashboardFrame and VendorDashboardFrame see the same simulated
 * orders. A status update from the vendor screen becomes visible on the
 ...
 *
 * TODO(Step 3/4 merge): replace usages of this class with a real
 * OrderDataSource implementation backed by OrderDAO once merged in.
 */
